...
Activity 3" and subsequently with the extraction of the information in table format from the website from the website https://es.investing.com/crypto/currencies
This extracted information will then be pasted into the Excel "Data Activity 3" Excel.
...
A cryptocurrency will be considered to have a high risk level when variability in the last 7 days has been less than 0. In this case, the value "High" will be written in the "Risk" column of Excel.
